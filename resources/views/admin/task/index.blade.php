        ...
        <?php $a=1; ?>
         @foreach($task as $list)
          <tr>
              ...
              <a href="{{url('admin/task/edit/'.$list->id)}}"><button class="btn btn-success">Edit</button></a>
              <a href="{{url('admin/task/delete/'.$list->id)}}"><button class="btn btn-danger">Delete</button></a>
